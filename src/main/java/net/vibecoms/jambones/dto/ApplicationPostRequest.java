...
public class ApplicationPostRequest {
    ...
    private ApplicationPostRequest() {
    }

    private ApplicationPostRequest(String name, String accountSid, String speechSynthesisVendor, String speechSynthesisVoice, String speechRecognizerVendor, String speechRecognizerLanguage, Hook callHook, Hook callStatusHook) {
        this.name = name;
    ...
    public static class Builder {
        ...
        public ApplicationPostRequest build() {
            return new ApplicationPostRequest(name, accountSid, speechSynthesisVendor, speechSynthesisVoice, speechRecognizerVendor, speechRecognizerLanguage, callHook, callStatusHook);
        }
    }
